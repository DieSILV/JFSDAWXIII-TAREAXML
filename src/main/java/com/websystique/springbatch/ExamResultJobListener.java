...
public class ExamResultJobListener implements JobExecutionListener {
    ...
    public void beforeJob(JobExecution jobExecution) {
        ...
        System.out.println("EXAMRESULT JOB COMIENZA:"+startTime);
    }
 
    @Override
    public void afterJob(JobExecution jobExecution) {
        stopTime = new DateTime();
        System.out.println("EXAMRESULT JOB STOPS:"+stopTime);
        System.out.println("TIEMPO TOTAL EN MILISEGUNDOS:"+getTimeInMillis(startTime , stopTime));
